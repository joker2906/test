...
import childdress from './childshirt.jpg';
import logo from './logo.jpg';
import { FaBars, FaSearch, FaTimes } from 'react-icons/fa';
import { useCart } from './CartContext';

export default function Childdress() {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({ name: 'Girls Party Dress', price: '₹299.99', size, image: childdress });
  };
  ...
  const handleAddToWishlist = () => {
    ...
    addToWishlist({ name: 'Girls Party Dress', price: '₹299.99', size, image: childdress });
  };
  return (
    <div>
      <header
      ...
      <main className="main-content">
        <section id="mens-section" className="mens-section" style={{ display: 'flex', alignItems: 'flex-start', gap: '2rem', padding: '2rem' }}>
          <div className="product-image-container" style={{ flex: '1', maxWidth: '50%'}}>
            <img src={childdress} alt="Child Dress" className="product-image" style={{ height: '60%', width: '60%', objectFit: 'cover' }} />
          </div>
          <div className="product-details" style={{ flex: '1', maxWidth: '50%', textAlign: 'center' }}>
            <h1 style={{ textAlign: 'center', fontFamily: "'Playfair Display', serif", color: '#ffd700', textShadow: '0 0 20px rgba(255, 215, 0, 0.5)' }}>Girls Party Dress</h1>
            ...
            <h3 style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.9)', fontWeight: '300' }}>Blue party dress with sequins,<br />
               puff sleeves, and bow details,<br />
               perfect for special occasions</h3>
            ...
            <p style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.7)' }}>The model (age 5 years) <br/>size 4-5 years</p>
            ...
            <p style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.7)' }}>Available Sizes: 2-3 years, 4-5 years, 6-7 years</p>
            ...
            <h3 className="product-title" style={{ textAlign: 'center', color: '#e8e8e8', fontWeight: '600' }}>Child Dress</h3>
