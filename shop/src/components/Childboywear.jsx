...
export default function Childboywear() {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({ name: 'Boys Denim Jacket', price: '₹349.99', size, image: childboywear });
  };
  ...
  const handleAddToWishlist = () => {
    ...
    addToWishlist({ name: 'Boys Denim Jacket', price: '₹349.99', size, image: childboywear });
  };
  return (
    <div>
      <header
      ...
      <main className="main-content">
        <section id="mens-section" className="mens-section" style={{ display: 'flex', alignItems: 'flex-start', gap: '2rem', padding: '2rem' }}>
          <div className="product-image-container" style={{ flex: '1', maxWidth: '50%'}}>
            <img src={childboywear} alt="Child Boy Wear" className="product-image" style={{ height: '60%', width: '60%', objectFit: 'cover' }} />
          </div>
          <div className="product-details" style={{ flex: '1', maxWidth: '50%', textAlign: 'center' }}>
            <h1 style={{ textAlign: 'center', fontFamily: "'Playfair Display', serif", color: '#ffd700', textShadow: '0 0 20px rgba(255, 215, 0, 0.5)' }}>Boys Denim Jacket</h1>
            ...
            <h3 style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.9)', fontWeight: '300' }}>Blue denim jacket with patches,<br />
               button closure, and comfortable fit,<br />
               perfect for casual outings</h3>
            ...
            <p style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.7)' }}>Brand Fit: Regular</p>
            <p style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.7)' }}>Fit: Regular Fit</p>
            <p style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.7)' }}>The model (age 10 years) <br/>size 10-11 years</p>
            ...
            <p style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.7)' }}>Available Sizes: 8-9 years, 10-11 years, 12-13 years</p>
            ...
            <h3 className="product-title" style={{ textAlign: 'center', color: '#e8e8e8', fontWeight: '600' }}>Child Boy Wear</h3>
