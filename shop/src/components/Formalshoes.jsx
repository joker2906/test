...
import formalshoes from './fromalshoes.jpg';
...
export default function Formalshoes() {
  ...
  const handleAddToCart = () => {
    ...
    const quantity = 1;
    addToCart({ name: 'Formal Shoes', price: '₹799.99', size, image: formalshoes }, quantity);
  };
  ...
  const handleAddToWishlist = () => {
    ...
    addToWishlist({ name: 'Formal Shoes', price: '₹799.99', size, image: formalshoes });
  };
    ...
    <main className="main-content">
        <section id="mens-section" className="mens-section" style={{ display: 'flex', alignItems: 'flex-start', gap: '2rem', padding: '2rem' }}>
          <div className="product-image-container" style={{ flex: '1', maxWidth: '50%'}}>
            <img src={formalshoes} alt="Formal Shoes" className="product-image" style={{ height: '60%', width: '60%', objectFit: 'cover' }} />
          </div>
          <div className="product-details" style={{ flex: '1', maxWidth: '50%', textAlign: 'center' }}>
            <h1 style={{ textAlign: 'center', fontFamily: "'Playfair Display', serif", color: '#ffd700', textShadow: '0 0 20px rgba(255, 215, 0, 0.5)' }}>Formal Shoes</h1>
            ...
            <h3 style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.9)', fontWeight: '300' }}>Classic black formal shoes,<br />
               leather upper, lace-up closure,<br />
               comfortable sole, perfect for office wear</h3>
            ...
            <p style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.7)' }}>Genuine Leather</p>
            ...
            <h3 className="product-title" style={{ textAlign: 'center', color: '#e8e8e8', fontWeight: '600' }}>Formal Shoes</h3>
