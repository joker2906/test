...
export default function Trackpants() {
  ...
  const handleAddToCart = () => {
    ...
    const quantity = 1;
    addToCart({ name: 'Mast & Harbour Men Track Pants', price: '₹349.99', size, image: trackpants }, quantity);
  };
  ...
  const handleAddToWishlist = () => {
    ...
    addToWishlist({ name: 'Mast & Harbour Men Track Pants', price: '₹349.99', size, image: trackpants });
  };
  return (
    <div>
      <header
      ...
      <main className="main-content">
        <section id="mens-section" className="mens-section" style={{ display: 'flex', alignItems: 'flex-start', gap: '2rem', padding: '2rem' }}>
          <div className="product-image-container" style={{ flex: '1', maxWidth: '50%'}}>
            <img src={trackpants} alt="trackpant" className="product-image" style={{ height: '60%', width: '60%', objectFit: 'cover' }} />
          </div>
          <div className="product-details" style={{ flex: '1', maxWidth: '50%', textAlign: 'center' }}>
            <h1 style={{ textAlign: 'center', fontFamily: "'Playfair Display', serif", color: '#ffd700', textShadow: '0 0 20px rgba(255, 215, 0, 0.5)' }}>Mast & Harbour Men Track Pants</h1>
            ...
            <h3 style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.9)', fontWeight: '300' }}>Black track pants,<br />
            ...
            <h3 className="product-title" style={{ textAlign: 'center', color: '#e8e8e8', fontWeight: '600' }}>Track Pants</h3>
