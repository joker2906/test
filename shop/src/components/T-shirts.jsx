...
export default function Tshirts() {
  ...
  const handleAddToCart = () => {
    ...
    const quantity = 1;
    addToCart({ name: 'Mast & Harbour Men Cotton T-Shirt', price: '₹249.99', size, image: tshirt }, quantity);
  };
  ...
  const handleAddToWishlist = () => {
    ...
    addToWishlist({ name: 'Mast & Harbour Men Cotton T-Shirt', price: '₹249.99', size, image: tshirt });
  };
  return (
    <div>
      <header
      ...
      <main className="main-content">
        ...
        >
          ...
          >
            <h1 style={{ textAlign: 'center', fontFamily: "'Playfair Display', serif", color: '#ffd700', textShadow: '0 0 20px rgba(255, 215, 0, 0.5)' }}>Mast & Harbour Men Cotton T-Shirt</h1>
            ...
            <h3 style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.9)', fontWeight: '300' }}>White cotton T-shirt,<br />
               has a round neck, short sleeves,<br />
               straight hem</h3>
            ...
            <h3 className="product-title" style={{ textAlign: 'center', color: '#e8e8e8', fontWeight: '600' }}>T-Shirt</h3>
