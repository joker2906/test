...
export default function Footheels() {
  ...
  const handleAddToCart = () => {
    ...
    const quantity = 1;
    addToCart({ name: 'High Heels', price: '₹699.99', size, image: footheels }, quantity);
  };
  ...
  const handleAddToWishlist = () => {
    ...
    addToWishlist({ name: 'High Heels', price: '₹699.99', size, image: footheels });
  };
    ...
    <main className="main-content">
        <section id="mens-section" className="mens-section" style={{ display: 'flex', alignItems: 'flex-start', gap: '2rem', padding: '2rem' }}>
          <div className="product-image-container" style={{ flex: '1', maxWidth: '50%'}}>
            <img src={footheels} alt="High Heels" className="product-image" style={{ height: '60%', width: '60%', objectFit: 'cover' }} />
          </div>
          <div className="product-details" style={{ flex: '1', maxWidth: '50%', textAlign: 'center' }}>
            <h1 style={{ textAlign: 'center', fontFamily: "'Playfair Display', serif", color: '#ffd700', textShadow: '0 0 20px rgba(255, 215, 0, 0.5)' }}>High Heels</h1>
            ...
            <h3 style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.9)', fontWeight: '300' }}>Elegant high heels,<br />
               stiletto design, comfortable padding,<br />
               perfect for formal occasions</h3>
            ...
            <h3 className="product-title" style={{ textAlign: 'center', color: '#e8e8e8', fontWeight: '600' }}>High Heels</h3>
            <p className="product-price" style={{ textAlign: 'center', color: '#ffd700', fontWeight: '700' }}>price - ₹699.99</p>
          </div>
        </section>
      </main>
    </div>
